...
\IEEEPARstart{M}{\MakeLowercase{it}} der zunehmenden dezentralisierung und
...
\begin{figure}[ht]
	...
	\centering
	\caption{GStreamer Architektur QUELLE von GSTREAMER DOCS}
\end{figure}
...
von Datenströmen. (Siehe Abbildung X und QUELLE!!)
...
von komplexeren Pipelines bereitstellt. (Siehe QUELLE)
