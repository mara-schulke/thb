...
\subsection{Vector Database API}\label{appendix:vector-db-api}
...
\subsubsection{Vector Database Schema}\label{appendix:vector-schema}
...
\subsubsection{Benchmark Traits}\label{appendix:benchmark-traits}
