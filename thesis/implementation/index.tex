...
The implementation is split into inference, sampling and evaluation code. The
...
The selection algorithm yields a maximum of 256 candidates (\texttt{TOP\_K =
256}) to limit computational overhead whilst maintaining selection quality.
