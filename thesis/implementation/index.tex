...
The self-refinement mechanism described in~\ref{design:refinement-function}
...
the database schema described in \ref{appendix:vector-schema}. Which maintains
...
match, candidate latency and error rate (see \ref{eval:metrics}). The execution
