...
\textsc{Natural}'s prompt together with a . \textsc{Natural} uses more explicit instructions
compared to DAIL-SQL. Key differentiations include the inclusion of similarity
scores to give the model the ability to weight the samples itself and 

The prompt emphasizes precision and chain-of-thought reasoning. 
This aims to address common LLM issues with over-generating information or missing
