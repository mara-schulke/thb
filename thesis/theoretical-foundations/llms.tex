...
Large language models (LLMs) are a recent advancement built on top of the
transformer architecture for natural language processing, demonstrating state
of the art capabilities in understanding, reasoning and text generation. These
models form the core of most modern NL2SQL systems like \textsc{XiYan-SQL},
\textsc{DAIL} and others. They have a wide language understanding as they have
been trained on large text corpora, are exposed to different domains of traning
data and have an inherent understanding of the SQL syntax as they have been
exposed to it during pre-training. This shifted the approach while developing
NL2SQL systems to focus on in-context learning methods instead of training
dedicated models from scratch.
...
question presentation mechanisms \citep{DAIL, OmniSQL}.
