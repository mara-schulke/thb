...
systems like \textsc{XiYan-SQL}, \textsc{DAIL} and others. They have a wide
language understanding as they have been trained on large text corpora, are
exposed to different domains of training data and have an inherent
...
focus on ICL learning methods instead of training dedicated models from
scratch.
