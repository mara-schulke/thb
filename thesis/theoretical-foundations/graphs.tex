...
distance) \citep{WWL}. For database schemas, WWL kernels can capture similar structural
patterns (table structures, possible joins, constraints) while remaining robust
to minor structure variations. This makes them well suited for NL2SQL example
selection algorithms that factor in schema similarity.
