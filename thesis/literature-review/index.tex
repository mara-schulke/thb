...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[
    ...
    % Representative systems / datasets per era
    \node[font=\small, align=center] at (0,-1.2)
      {\textsc{Lunar}, \textsc{Ladder}\\grammar / rules};
    \node[font=\small, align=center] at (4.5,-1.2)
      {\textsc{Seq2SQL}\\WikiSQL};
    \node[font=\small, align=center] at (9.0,-1.2)
      {BERT, T5\\\textsc{Spider}};
    \node[font=\small, align=center] at (13.5,-1.2)
      {GPT-4, Codex\\\textsc{Bird}, \textsc{Spider}2.0};
  \end{tikzpicture}
