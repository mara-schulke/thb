...
% NOTE: Condense (reduce from 1,437 words to ~500-600 words - approaches from 1990s-2010s are obsolete compared to LLM methods; keep key insights about brittleness and limited transferability but remove detailed system descriptions for rule-based, string-kernels, graph matching, interactive systems, and query synthesis sections; compress limitations enumeration into narrative)
