...
% NOTE: Condense from 1,4k words to ~600 words, most of it is obsolete
...
formal grammer like LSNLIS developed by \cite{Lunar} and learning / training
...
NaLIR proved that chosing the right interaction model could offset system
