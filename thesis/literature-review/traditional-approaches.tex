...
constructs they can process, as well as runtime adoption of new or unknown
...
formal grammar like LSNLIS developed by \cite{Lunar} with learned approaches
for generalizing to unseen natural language query structures. This allowed for
more flexible pattern recognition when compared to traditional rule-based
systems.
