...
\textsc{Precise} system lies in its natural language processing approach,
its lexical mapping strategy, allowing \textsc{Precise} to
...
approach is \textit{transferable} and \textit{unbiased} — they can
...
\begin{enumerate}
    \item The trade-off characteristics derived from choosing a machine
        ...
        \textsc{Precise}), particularly coverage versus correctness.
