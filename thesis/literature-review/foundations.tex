...
\begin{enumerate}
    \item Trade-off characteristics derived from choosing a machine
        learning over a traditional NLP approach (e.g. \textsc{Chill} vs.
        \textsc{Precise}).
    \item Linguistic challenges associated with bringing NLIDBs into use
        which include semantic inaccuracy and linguistic ambiguity.
    \item Value of systems that emphasize reliability and semantic accuracy
        rather than giving promising but incorrect answers.
\end{enumerate}
...
This highlights the tension between natural language, which can be ambiguous,
semantically intractable or incomplete in meaning and
