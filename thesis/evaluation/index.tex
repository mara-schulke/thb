...
produced by NL2SQL systems. Execution accuracy is computed by determining whether
...
performance indicates that a misaligned prompt template (i.e., divergent from
...
benchmarking harness is based around the \texttt{sqlparser} crate in Rust
...
improvement could be measured (e.g., \textit{Syn} achieving 53.8\% vs \OmniSQL~7B
