...
$q_g$ contains an \texttt{ORDER BY} clause. Row and value comparisons use
tolerance-based equality for floating-point values ($|\cdot| < 10^{-5}$). The
calculation for measuring \textsc{Natural}'s EA was ported from \textsc{Spider}
\citep{Spider}.
...
\textcolor{red}{X} external baselines are referenced from previous research:
