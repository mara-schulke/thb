...
% FIGURE
% figure of performance diff between omnisql
...
% FIGURE
% figure of performance landscape with baselines
...
% FIGURE
% candidate latency figure on spider dev and test
...
per hundred queries), indicating that failures are predominantly semantic
(incorrect results) rather than syntactic (malformed SQL), which validates the
robustness of \textsc{OmniSQL}'s SQL generation capabilities.
