...
% TODO: CRITICAL - Replace verbatim with a proper figure/flowchart using TikZ or similar
% TODO: This looks unprofessional. Create a proper algorithmic flowchart showing:
% TODO:   1. Input (NL query), 2. Pipeline stages, 3. Iteration loop, 4. Output (SQL)
% TODO: Use the algorithm2e package for better formatting
