...
This chapter introduces the architecture of the NL2SQL system \textsc{Natural},
which addresses limitations and research gaps identified in the literature
review. \Natural~is architected as a pipeline that transforms NLQs into SQL
queries consisting of five components:
...
The system processes queries using the following architecture:
...
\citep{DAIL-SQL} and OmniSQL \citep{OmniSQL} but incorporates a novel
schema-aware example selection technique which uses graph kernels for
structural similarity between databases.
