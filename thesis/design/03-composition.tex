...
and $\omega \in \Omega_{\mathcal{S}}$ is the generated SQL query. The $nq$
function implements Algorithm~\ref{algorithms:nq}.

\begin{algorithm}
\caption{$nq$ - Natural Query Pipeline}\label{algorithms:nq}
\begin{algorithmic}[1]
