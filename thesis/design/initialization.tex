...
\citep{DAIL-SQL}. The system uses cosine similarity to identify relevant examples based
on both the natural language queries and SQL statements, allowing efficient retrieval from
