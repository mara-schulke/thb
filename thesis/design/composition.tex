...
The $nq$ function composes the system by establishing a
zero-shot baseline, then using precomputed embedding space $v$ and distance
index $d$ from initialization to guide few-shot generation while
self refining results through execution feedback and yielding the most likely
