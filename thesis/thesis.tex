...
% AB HIER WEITER PLS
%CHASE-SQL: Multi-path reasoning and candidate selection \citep{CHASE}
%XiYan-SQL: Multi-generator ensemble framework \citep{XiYan}
%Agent specialization and collaboration patterns
%Voting and selection mechanisms for query ranking
