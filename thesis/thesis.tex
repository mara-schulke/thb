...
a far more sophisticate architecture when it comes to natural language analysis. The application of T5-3B for NL2SQL
tasks which yielded 71.4\% execution accuracy presented a breakthrough in this research domain \citep{T2SQL-LLM-Bench-3}.
This demonstrated that PLMs are correctly positioned to significantly outperform existing approaches.
...
\subsubsection{Intermediate Pre-trained Language Model Approaches}

% RYANSQL, GAZP
% RESDSQL, GRAPHIX, NATSQL
