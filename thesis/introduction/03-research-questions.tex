...
schemas and queries must be transmitted to an external API that is used for
the actual inference. This incurs risks, ongoing and uncontrolled costs and a
