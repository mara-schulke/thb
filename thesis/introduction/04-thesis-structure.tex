...
\begin{enumerate}
    \item \textbf{Literature Review} — Analysis of existing research on NLIDB.
        ...
        SOTA approaches, their benefits and shortcomings.
    ...
    \item \textbf{Evaluation} — Benchmarking the implementation against
        standard evaluation datasets that evaluate the implementation's
    ...
    \item \textbf{Discussion} — Analysis and interpretation of the evaluation
        ...
        during the evaluation and determining the impact of approaches used.
        Addresses limitations of this thesis and the accompanying implementation.
    \item \textbf{Summary} — Summarizes the core contributions and
